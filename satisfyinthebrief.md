...
// using google maps and places etc
// using data structures to store patient information


* **Have an interactive front-end**, preferably using a modern front-end framework

// unlikely
// is angular best to use?


* **Be a complete product**, which most likely means multiple relationships and CRUD functionality for at least a couple models

// will be able to CRUD users
// patient will belong to ambulance when they arrive
// patien will then belong to hospital when they arrive there

* **Use a database**, whether that's one we've covered in class or one you want to learn

// used to persist user information
...
// use bootstrap
// use snazzymaps
// use pulse to show alert


* **Be deployed online** so it's publicly accessible

// using heroku and persisting with mongo
