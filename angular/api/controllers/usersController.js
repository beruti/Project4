...
function userDelete(req, res){
  ...
  // console.log(global.currentUser.$__.scope.req.params.userid)
  // console.log("-----------------------------------------")
   User.findById({_id: req.params.userid}).exec(function(err, user){//.populate('posts').exec(function(err, user) {
